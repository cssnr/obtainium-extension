...
[![Workflow Build](https://img.shields.io/github/actions/workflow/status/cssnr/obtainium-extension/build.yaml?logo=norton&logoColor=white&label=build)](https://github.com/cssnr/obtainium-extension/actions/workflows/build.yaml)
[![Workflow Test](https://img.shields.io/github/actions/workflow/status/cssnr/obtainium-extension/test.yaml?logo=norton&logoColor=white&label=test)](https://github.com/cssnr/obtainium-extension/actions/workflows/test.yaml)
[![Workflow Lint](https://img.shields.io/github/actions/workflow/status/cssnr/obtainium-extension/lint.yaml?logo=norton&logoColor=white&label=lint)](https://github.com/cssnr/obtainium-extension/actions/workflows/lint.yaml)
[![GitHub Last Commit](https://img.shields.io/github/last-commit/cssnr/obtainium-extension?logo=listenhub&label=updated)](https://github.com/cssnr/obtainium-extension/pulse)
[![GitHub Repo Size](https://img.shields.io/github/repo-size/cssnr/obtainium-extension?logo=buffer&label=repo%20size)](https://github.com/cssnr/obtainium-extension?tab=readme-ov-file#readme)
[![GitHub Top Language](https://img.shields.io/github/languages/top/cssnr/obtainium-extension?logo=devbox)](https://github.com/cssnr/obtainium-extension?tab=readme-ov-file#readme)
[![GitHub Contributors](https://img.shields.io/github/contributors-anon/cssnr/obtainium-extension?logo=southwestairlines)](https://github.com/cssnr/obtainium-extension/graphs/contributors)
[![GitHub Issues](https://img.shields.io/github/issues/cssnr/obtainium-extension?logo=codeforces&logoColor=white)](https://github.com/cssnr/obtainium-extension/issues)
[![GitHub Discussions](https://img.shields.io/github/discussions/cssnr/obtainium-extension?logo=theconversation)](https://github.com/cssnr/obtainium-extension/discussions)
[![GitHub Forks](https://img.shields.io/github/forks/cssnr/obtainium-extension?style=flat&logo=forgejo&logoColor=white)](https://github.com/cssnr/obtainium-extension/forks)
[![GitHub Repo Stars](https://img.shields.io/github/stars/cssnr/obtainium-extension?style=flat&logo=gleam&logoColor=white)](https://github.com/cssnr/obtainium-extension/stargazers)
...
> Submit a [Feature Request](https://github.com/cssnr/obtainium-extension/issues/new?template=1-feature.yaml).
...
- Request a Feature: <https://github.com/cssnr/obtainium-extension/issues/new?template=1-feature.yaml>
- Chat with us on Discord: <https://discord.gg/wXy6m2X8wY>

[![Features](https://img.shields.io/badge/features-brightgreen?style=for-the-badge&logo=rocket&logoColor=white)](https://github.com/cssnr/obtainium-extension/issues/new?template=1-feature.yaml)
[![Issues](https://img.shields.io/badge/issues-red?style=for-the-badge&logo=southwestairlines&logoColor=white)](https://github.com/cssnr/obtainium-extension/issues)
[![Discussions](https://img.shields.io/badge/discussions-blue?style=for-the-badge&logo=livechat&logoColor=white)](https://github.com/cssnr/obtainium-extension/discussions)
...
on [Google](https://chromewebstore.google.com/detail/obtainium-extension/flmepeihikildcikjbmikbbmbeemedja)
or [Mozilla](https://addons.mozilla.org/addon/obtainium-extension) and star this project on GitHub.
...
<a href="https://github.com/cssnr/obtainium-extension/stargazers">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=cssnr/obtainium-extension&type=date&legend=bottom-right&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=cssnr/obtainium-extension&type=date&legend=bottom-right" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=cssnr/obtainium-extension&type=date&legend=bottom-right" />
 </picture>
</a>
